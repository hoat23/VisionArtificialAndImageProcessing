...
<div align="center">
<img src="https://latex.codecogs.com/svg.latex?\Large&space;I:\{{\mathbb{X}}\subseteq{\mathbb{R}}^{n}\}\rightarrow\{{\text{Min}},..,{\text{Max}}\}" hight="20"/> 
</div>

With intensity values in the range (Min,Max), into a new image:
<div align="center">
<img src="https://latex.codecogs.com/svg.latex?\Large&space;I_{N}:\{{\mathbb{X}}\subseteq%20{\mathbb%20{R}}^{n}\}\rightarrow\{{\text{newMin}},..,{\text{newMax}}\}" hight="20"/>
</div>
...
<div align="center">
<img src="https://latex.codecogs.com/svg.latex?\Large&space;I_{N}=({{\text{newMax}}-{\text{newMin}}})%20({\frac{{I-{\text{Min}}}%20}{{\text{Max}}-{\text{Min}}}})+{\text{newMin}}" width="400"/>
</div>
